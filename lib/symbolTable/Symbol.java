...
abstract public class Symbol implements Cloneable {
    ...
    //será NONE para lo que sea que no sea un parámetro
    public ParameterClass parClass; // valor, referencia, NONE

    //dirección en memoria. Para func/proc, dirección de la primera instrucción
    public long dir;

    //mi tipo
    public Types type;      // int, bool, char, array, funcion, procedimiento, string, indefinido

    // es constante?
    public boolean constant;

    //nivel dentro de la TS
    public int nivel;
